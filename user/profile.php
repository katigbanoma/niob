                                ...
                                <div class="user-content">
                                    <?php if (isset($_SESSION['account'])) { ?>
                                        <a href="javascript:void(0)"><img
                                                src="file://<?php echo $_SESSION['account']['passport'] ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="member_registration_number"
                                               ...
                                               value="<?php if (isset($_SESSION['account'])) {
                                                   echo $_SESSION['account']['member_registration_number'];
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-2 mb-sm-0">
                                            ...
                                            <input type="text" name="corbon_number" id="corbon_number"
                                                   ...
                                                   value="<?php if (isset($_SESSION['account'])) {
                                                       echo $_SESSION['account']['corbon_number'];
                                    ...
                                    <div class="col-md-6 input-group date">
                                        ...
                                        <input type="text" class="form-control" name="niob_admission_date" placeholder="Select NIOB Admission Date"
                                               id="niob_admission_date" value="<?php if (isset($_SESSION['account'])) {
                                            echo $_SESSION['account']['niob_admission_date'];
                                        } ?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control form-control-line rmv" name="member_title"
                                            ...
                                            <option value='Alhaji' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Alhaji' ? 'selected' : '';
                                            } ?>>Alhaji
                                            </option>
                                            <option value='Chief' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Chief' ? 'selected' : '';
                                            } ?>>Chief
                                            </option>
                                            <option value='Comrade' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Comrade' ? 'selected' : '';
                                            } ?>>Comrade
                                            </option>
                                            <option value='Doctor' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Doctor' ? 'selected' : '';
                                            } ?>>Doctor
                                            </option>
                                            <option value='Emperor' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Emperor' ? 'selected' : '';
                                            } ?>>Emperor
                                            </option>
                                            <option value='Engineer' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Engineer' ? 'selected' : '';
                                            } ?>>Engineer
                                            </option>
                                            <option value='Miss' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Miss' ? 'selected' : '';
                                            } ?>>Miss
                                            </option>
                                            <option value='Mr' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Mr' ? 'selected' : '';
                                            } ?>>Mr
                                            </option>
                                            <option value='Mrs' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Mrs' ? 'selected' : '';
                                            } ?>>Mrs
                                            </option>
                                            <option value='Pastor' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Pastor' ? 'selected' : '';
                                            } ?>>Pastor
                                            </option>
                                            <option value='Professor' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Professor' ? 'selected' : '';
                                            } ?>>Professor
                                            </option>
                                            <option value='Reverend' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['title'] == 'Reverend' ? 'selected' : '';
                                            } ?>>Reverend
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="other_names" placeholder="Other Names"
                                               value="<?php if (isset($_SESSION['account'])) {
                                                   echo $_SESSION['account']['other_names'];
                                               } ?>" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select name="gender" id="gender" class="form-control form-control-line"
                                            ...
                                            <option value="male" <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['gender'] == 'male' ? 'selected' : '';
                                            } ?>>Male
                                            </option>
                                            <option value="female" <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['gender'] == 'female' ? 'selected' : '';
                                            } ?>>Female
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="religion" id="religion" class="form-control form-control-line">
                                            ...
                                            <option value="Islam" <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['religion'] == 'Islam' ? 'selected' : '';
                                            } ?>> Islamic
                                            </option>
                                            <option value="Christianity" <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['religion'] == 'Christianity' ? 'selected' : '';
                                            } ?>> Christianity
                                            </option>
                                            <option value="Traditional" <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['religion'] == 'Traditional' ? 'selected' : '';
                                            } ?>> Traditional
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group" style="padding: 20px;">
                                    <div class="col-md-12 input-group date">
                                        ...
                                        <input type="text" class="form-control" name="dob"
                                               placeholder="Select date of birth" id="dob" data-date-format="yy-mm-dd" value="<?php if (isset($_SESSION['account'])) {
                                            echo $_SESSION['account']['dob'];
                                        } ?>">
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control form-control-line" name="highest_acad_qual" id="highest_acad_qual" required>
                                            ...
                                            <option value='Phd' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'Phd' ? 'selected' : '';
                                            } ?>>Phd
                                            </option>
                                            <option value='Msc' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'Msc' ? 'selected' : '';
                                            } ?>>Msc
                                            </option>
                                            <option value='PGD' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'PGD' ? 'selected' : '';
                                            } ?>>PGD
                                            </option>
                                            <option value='Bachelors' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'Bachelors' ? 'selected' : '';
                                            } ?>>Bsc/B.Tech
                                            </option>
                                            <option value='HND' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'HND' ? 'selected' : '';
                                            } ?>>HND
                                            </option>
                                            <option value='OND' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'OND' ? 'selected' : '';
                                            } ?>>OND
                                            </option>
                                            <option value='NCE' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'NCE' ? 'selected' : '';
                                            } ?>>NCE
                                            </option>
                                            <option value='WASSCE' <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['highest_acad_qual'] == 'WASSCE' ? 'selected' : '';
                                            } ?>>WASSCE
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 input-group date" data-provide="year">
                                        ...
                                        <input type="text" class="form-control year" name="year_education"
                                               ...
                                               value="<?php if (isset($_SESSION['account'])) {
                                            echo $_SESSION['account']['year_education'];
                                        } ?>" required>
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" placeholder="Current Employer" name="current_employer"
                                               value="<?php if (isset($_SESSION['account'])) {
                                                   echo $_SESSION['account']['current_employer'];
                                               } ?>" class="form-control form-control-line" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="position_held" placeholder="Position Held"
                                               value="<?php if (isset($_SESSION['account'])) {
                                                   echo $_SESSION['account']['position_held'];
                                               } ?>" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="additional_info" id="additional_info" rows="3"
                                                  class="form-control form-control-line">
                                            <?php if (isset($_SESSION['account'])) {
                                                echo $_SESSION['account']['additional_info'];
                                            } ?>
                                        </textarea>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        function setupFields() {
            ...
            var reg = null;
            <?php if (isset($_SESSION['account'])) { ?>
                reg = '<?php echo $_SESSION['account']['status'] ?>';
            <?php } ?>
