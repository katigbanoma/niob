...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    ...
    <head>
        ...
        <script>
            function myFunction() {
                alert("Hello! Be cool, online payment is coming here soon! For now, just explore the site");
            }
        </script>
    </head>
        ...
        <div id="site-wrapper">
            ...
            <div id="splash" >
                ...
                <div class="col3 left">
                    ...
                    <p>"To enable members deliver, with relevant stakeholders, sustainable shelter that addresses the housing needs of the Nation through research and development and global best practices"</p>
                </div>
                ...
                <div class="col3 right">
                    ...
                    <p>The Nigerian Institute of Building is the professional body for Builders and those who are about to be engaged in the Building Profession</p>
                    <p><a href="https://vikpe.org/archive/arcsin-web-templates/" class="more">Read more &#187;</a><span class="quiet"></span></p>
                </div>
                        ...
                        <div class="section-content">
                            ...
                            <div class="post">
                                ...
                                <div class="post-body">
                                    ...
                                    <p class="large">This is a free website template by <a href="https://vikpe.org/">Viktor Persson</a>, built using tableless XHTML and CSS.</p>

                                    <p>The latest template version and CMS conversions for platforms such as WordPress and Blogger can be found at the official <a href="https://vikpe.org/archive/arcsin-web-templates/simple-organization-website-template/">Simple Organization Website Template</a> page.</p>

                                    <p>For more templates, questions and comments please visit <a href="https://vikpe.org/archive/arcsin-web-templates/">Arcsin Web Templates</a>.</p>
            ...
            <div id="footer">
                ...
                <div class="right" id="footer-right">
                    <p ><a href="#">Blog</a> <span class="text-separator">|</span> <a href="#">Events</a> <span class="text-separator">|</span> <a href="#">About</a> <span class="text-separator">|</span> <a href="#">Archives</a> <span class="text-separator">|</span> <strong><a href="#">Join Us!</a></strong> <span class="text-separator">|</span> <a href="#top" class="quiet">Page Top &uarr;</a></p>
                </div>
                <div class="clearer">&nbsp;</div>
            </div>
        </div>
