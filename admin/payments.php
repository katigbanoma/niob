...
<!--                            <img src="/static/plugins/images/admin-text.png" alt="home" class="dark-logo" />-->
<!--                            <img src="/static/plugins/images/admin-text-dark.png" alt="home" class="light-logo" />-->
<!--                        </span>-->
<!--                    </a>-->
                    <a class="logo" href="index.php">
                        <b><img src="../img/logo-rsz.png" alt="home" class="light-logo" /></b>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive">
                                ...
                                $query = "SELECT * FROM `payment_reference` ORDER BY created_at DESC";
                                $results_array = array();
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $arr['reference'] ?></td>
                                            <td><?php echo $arr['amount'] ?></td>
                                            <td><?php echo$arr['description'] ?></td>
                                            <td><?php echo $arr['status'] == 1 ? 'RESOLVED': 'PENDING'  ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
